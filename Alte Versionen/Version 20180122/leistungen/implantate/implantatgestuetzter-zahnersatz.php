...
<html lang="de">
	<head>
		...
		<meta name="keywords" content="Zahnarzt, Zahnärzte, Zahnatztpraxis, Berlin, Hellerdsdorf, Marzahn, Helle-Mitte, Gemeinschaftspraxis, Katrin, Kunath, Dornberger, Schmidt, Al-Hasaki, Implantat, Implantologie, Brücken, Prothese, Zahnschmerzen, Notfall, Notdienst, Narkosebehandlung, Narkose, Bleeching, weiße Zähne, Angstbehandlung, Schmerzpatienten, Interdisziplinäre Sprechstunden, Russisch, Ästehetik, Prophylaxe, Operation, Weisheitszähne, Paradontose, Putzen, Zahnbürste, Zahnärzte in Berlin, implantatgestützt, prothetisch, Versorgung, Genauigkeit, Präzision">
		<meta name="descritpion" content="Der implantatgestützte Zahnersatz ist ein hochpräziser Prozess, bei dem schon ein Fehler fatal sein kann. Auf die Zahndocs Berlin können Sie sich in Sachen Präzision voll und ganz verlassen." />
	  
		<title>Implantatgestützter Zahnersatz - Zahndocs-Berlin</title>
		...
		<div id="wrapper">
			...
			<main>
				...
				<ul class="breadcrumb">
					...
					<li>
						<span>→</span>
						<span>Implantatgestützter Zahnersatz</span>
					</li>
				...
				<section>
					...
					<h2>Implantatgestützter Zahnersatz</h2>
