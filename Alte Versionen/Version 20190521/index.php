...
<html lang="de">
	<head>
		...
		<title>Home - Zahndocs-Berlin</title>
		...
		<div id="wrapper">
			...
			<header id="header" >
				...
				<div id="above-nav">
					...
					<a class="booking-link fullscreen" href="javascript:toggleDrFlexAppointments()"><i class="material-icons">event</i></a>
					<div id="brandarea">
			...
			<main>
				...
				<h2 class="just-mobile">Home</h2>
			
				<section>
				
					<p>Herzlich Willkommen bei den Zahndocs Berlin in der Praxis von ZÄ Katrin Kunath & Kollegen im Berliner <a title="Link zum Ärztezentrum Helle Mitte" href="http://www.helle-mitte.net/index.php?id=2-22-0-295">Ärztezentrum HelleMitte</a>.</p>

                    <h3>Neuigkeiten:</h3>

                    <p>Liebe Patientinnen, liebe Patienten,
                        <br />
                        <br />
                        nach über 11 Jahren nehme ich aus persönlichen Gründen Abschied von meiner Arbeit bei den Zahndocs Berlin.
                        Ich möchte mich bei Ihnen ganz herzlich für Ihr entgegengebrachtes Vertrauen bedanken und wünsche Ihnen für Ihre Zukunft alles Gute; ganz besonders aber wünsche ich Ihnen eine gute Zahngesundheit.
                        Ein weiteres herzliches Dankeschön gilt meinen stets sehr zuverlässigen, engagierten und hilfsbereiten Mitarbeiterinnen und Kollegen, allen voran Frau ZÄ Katrin Kunath, die Sie natürlich auch weiterhin bei den Zahndocs Berlin betreuen werden.
                        <br />
                        <br />
                        Mit herzlichen Grüßen<br />
                        Ihr Dr. Wieland Schmidt
                    </p>
				
					<img src="images/2017-03-31Zahndocs-1116-1-300x200.jpg" alt="Eingangsbereich der Zahnarztpraxis" />
					
					<p><strong>Wir sorgen für Ihr strahlendstes Lächeln!</strong></p>
					
					<p>Auf unserer Homepage erhalten Sie Informationen über unser Team und unsere Leistungen.</p>

					<p>Beachten Sie bitte auch die individuellen behandlerbezogenen Sprech- und Urlaubszeiten.</p>
