...
<html lang="de">
	<head>
		...
		<meta name="keywords" content="Zahnarzt, Zahnärzte, Zahnatztpraxis, Berlin, Hellerdsdorf, Marzahn, Helle-Mitte, Gemeinschaftspraxis, Katrin, Kunath, Dornberger, Schmidt, Al-Hasaki, Implantat, Implantologie, Brücken, Prothese, Zahnschmerzen, Notfall, Notdienst, Narkosebehandlung, Narkose, Bleeching, weiße Zähne, Angstbehandlung, Schmerzpatienten, Interdisziplinäre Sprechstunden, Russisch, Ästehetik, Prophylaxe, Operation, Weisheitszähne, Paradontose, Putzen, Zahnbürste, Zahnärzte in Berlin, Azubis, Stellenagebot">
		<meta name="descritpion" content="Das Team der Zahndcos Berlin freut sich auf Deine Bewerbung!" />
	  
		<title>Stellenangebote - Zahndocs-Berlin</title>
		...
		<link rel="stylesheet" href="style/stellenangebote-style.css" type="text/css" />
	...
	<body>
		...
		<div id="wrapper">
				...
				<nav id="main-nav" >
					<ul>
						...
						<li class="li" id="index">
							<span>Stellen&shy;angebote</span>
						</li>
						<li class="li">
			...
			<main>
				...
				<h2 class="just-mobile">Stellenangebot</h2>
			
				<section>
			
                    <p>Wir <b>suchen</b> eine/einen motivierte/n, qualitäts- und fotbildungsorientierte/n Zahnärztin/Zahnarzt <b>ab Januar 2019</b> in <b>Voll- oder Teilzeit</b>.</p>
					<p>Eine leistungsgerechte Vergütung, sowie sehr gute Fortbildungsmöglichkeiten sichern wir Ihnen zu.</p>
                    <p>Wir freuen uns auf Ihre Bewerbung!</p>
                    <p>Weitere Informationen erfragen Sie gern telefonisch bei Frau Sandra Lupuleak unter: <b>030-99 49 90 92</b> (8 - 14 Uhr)</p>
                    <p>Bewerbungsunterlagen können Sie wie folgt einreichen:</p>
					<p><b>per E-Mail: </b><a class="mail">praxis@zahndocs-berlin.de</a><br />
					oder<br />
					<b>per Post:</b></p>
					<p>Zahndocs Berlin</p>
					<p>ZÄ Katrin Kunath &amp; Kollegen</p>
					<p>Kurt-Weill-Gasse 4</p>
					<p>12627 Berlin</p>
