...
<html lang="de">
	<head>
		...
		<title>Fehler 400 - Zahndocs-Berlin</title>
		...
		<div id="wrapper">
			...
			<main>
				...
				<section>
					...
					<h1 class="error">Fehler 400</h1>
					
					<p>Es tut uns leid, aber leider enthielt Ihre Anfrage Fehler. Versuchen Sie, die Homepage über diesen Link aufzurufen: <a href="http://zahndocs-berlin.de">Homepage der Zahndocs Berlin</a></p>
