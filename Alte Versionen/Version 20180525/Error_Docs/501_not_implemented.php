...
<html lang="de">
	<head>
		...
		<title>Fehler 501 - Zahndocs-Berlin</title>
		...
		<div id="wrapper">
			...
			<main>
				...
				<section>
					...
					<h1 class="error">Fehler 501</h1>
					
					<p>Es tut uns leid, aber leider konnte Ihre Anfrage vom Server nicht bearbeitet werden. Versuchen Sie, die Homepage über diesen Link aufzurufen: <a href="http://zahndocs-berlin.de">Homepage der Zahndocs Berlin</a></p>
