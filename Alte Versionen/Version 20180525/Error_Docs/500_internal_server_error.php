...
<html lang="de">
	<head>
		...
		<title>Fehler 500 - Zahndocs-Berlin</title>
		...
		<div id="wrapper">
			...
			<main>
				...
				<section>
					...
					<h1 class="error">Fehler 500</h1>
					
					<p>Es tut uns leid, aber irgendwas ist schief gelaufen. Versuchen Sie, die Homepage über diesen Link aufzurufen: <a href="http://zahndocs-berlin.de">Homepage der Zahndocs Berlin</a></p>
