...
<html lang="de">
	<head>
		...
		<title>Fehler 503 - Zahndocs-Berlin</title>
		...
		<div id="wrapper">
			...
			<main>
				...
				<section>
					...
					<h1 class="error">Fehler 503</h1>
					
					<p>Zur Zeit ist unsere Website aus Wartungs- oder Kapazitätsgründen leider nicht erreichbar. Bitte versuchen Sie es etwas später erneut, wir sind so schnell wie möglich wieder für Sie da :)</p>
