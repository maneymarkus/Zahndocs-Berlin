...
<html lang="de">
	<head>
		...
		<title>Fehler 404 - Zahndocs-Berlin</title>
		...
		<div id="wrapper">
			...
			<main>
				...
				<section>
					...
					<h1 class="error">Fehler 404</h1>
					
					<p>Es tut uns leid, aber leider wurde die von Ihnen angeforderte Seite nicht gefunden. Vielleicht finden Sie im Menü weiter oben, wonach Sie suchen.</p>
