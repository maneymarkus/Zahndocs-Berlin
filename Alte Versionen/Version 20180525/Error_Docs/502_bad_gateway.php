...
<html lang="de">
	<head>
		...
		<title>Fehler 502 - Zahndocs-Berlin</title>
		...
		<div id="wrapper">
			...
			<main>
				...
				<section>
					...
					<h1 class="error">Fehler 502</h1>
					
					<p>Es tut uns leid, aber leider hat unser Server Probleme, ihre Anfrage zu bearbeiten. Versuchen Sie, die Homepage über diesen Link aufzurufen: <a href="http://zahndocs-berlin.de">Homepage der Zahndocs Berlin</a></p>
